...
(defvar fancy-splash-image-template
  (expand-file-name "cacomon-template.svg" fancy-splash-image-directory)
...
#+end_src
*** Look for unrecognised hex string that aren't greyscale
#+begin_src emacs-lisp
...
#+end_src
*** There's No need for ~doom-display-benchmark-h~ to be shown in the minibuffer
#+begin_src emacs-lisp
